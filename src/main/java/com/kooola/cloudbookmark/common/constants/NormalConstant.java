...
public class NormalConstant {
    ...
    public static final String CBM_MAIL_NICKNAME = "Mark-Mouse";  //发件箱账户昵称

    public static final String CBM_MAIL_STMP_ADDRESS = "smtp.163.com";  //邮箱stmp服务地址

    public static final String CBM_MAIL_ACCOUNT = "mark_mouse@163.com"; //云书签发件人账号
    ...
    public static final String CBM_MAKE_ACTIVATION_URL = "http://localhost:8080/user/active"; //用户邮箱激活url

//    public static final String CBM_MAKE_ACTIVATION_URL = "http://47.95.242.162:8080/user/active"; //用户邮箱激活url
}
